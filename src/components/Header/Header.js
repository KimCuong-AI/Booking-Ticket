        ...
        <div className="header__content" >
            <div className="navbar navbar-expand-lg navbar-light ">
                ...
                <div className="collapse navbar-collapse navbar-center" id="collapsibleNavId" >
                    <form onSubmit={handleFormSubmit} className="form-inline my-2 my-lg-0 form__submit d-lg-none d-block ">
                    ...
                    {!localStorage.getItem(USER_LOGIN) ?
                        ...
                        <ul className='navbar-nav'>
                            <li className="nav-item dropdown " >
                                ...
                                <div className="dropdown-menu " aria-labelledby="dropdownId" style={{maxWidth:'200px'}}>
                    ...
                    <form onSubmit={handleFormSubmit} className="form-inline my-2 my-lg-0 form__submit d-none d-lg-block ">
                        <input value={state.searchText} onChange={handleSearchInput} className="form-control mr-sm-2 w-100" type="text" placeholder="Tìm kiếm phim" />
                        <button className="my-sm-0" type="submit"><i className="fa fa-search"></i></button>
                    </form>
                </div>
